...
"""
function monteCarloSim(prob::SDEProblem;Δt::Number=0,tspan=[0,1],numMonte=10000,fullSave=true,alg="SRI",adaptive=false,abstol=1e-3,reltol=1e-2,adaptiveAlg="RSwM3")
  elapsedTime = @elapsed solutions = pmap((i)->solve(prob,tspan,Δt=Δt,fullSave=fullSave,alg=alg,adaptive=adaptive,abstol=abstol,reltol=reltol,adaptiveAlg=adaptiveAlg),1:numMonte)
