...
const DIFFERENTIALEQUATIONSJL_SPECIALDENSEALGS = Set([:DP5,:DP5Vectorized,:DP5Threaded,:Tsit5,:Tsit5Vectorized]) # These algs have a speical dense output, others just Hemite
