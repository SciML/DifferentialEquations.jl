...
const DIFFERENTIALEQUATIONSJL_SPECIALDENSEALGS = Set([:DP5,:DP5Vectorized,:DP5Threaded,:Tsit5,:Tsit5Vectorized,:BS5,:BS5Vectorized,:Vern6,:Vern6Vectorized,:Vern7,:Vern7Vectorized,:Vern8,:Vern8Vectorized,:Vern9,:Vern9Vectorized,]) # These algs have a speical dense output, others just Hemite
