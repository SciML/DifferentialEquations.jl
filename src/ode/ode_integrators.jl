...
function ode_feagin10(f::Function,u,t,Δt,T,iter,order,
                        maxiters,timeseries,ts,timeseries_steps,save_timeseries,
...
function ode_feagin12(f::Function,u,t,Δt,T,iter,order,
                        maxiters,timeseries,ts,timeseries_steps,save_timeseries,
                        γ,adaptive,abstol,reltol,qmax,Δtmax,Δtmin,internalnorm,progressbar)
...
function ode_feagin14(f::Function,u,t,Δt,T,iter,order,
                        maxiters,timeseries,ts,timeseries_steps,save_timeseries,
                        γ,adaptive,abstol,reltol,qmax,Δtmax,Δtmin,internalnorm,progressbar)
