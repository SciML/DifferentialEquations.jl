...
TEST_PLOT && p1 = plot(sol,plottrue=true,legend=false,title="tol = 1")
...
TEST_PLOT && p2 = plot(sol2,plottrue=true,legend=false,title="tol = 1e-1")
...
TEST_PLOT && p3 = plot(sol3,plottrue=true,legend=false,title="tol = 1e-2")
...
TEST_PLOT && p4 = plot(sol4,plottrue=true,legend=false,title="tol = 1e-3")
