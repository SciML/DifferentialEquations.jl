...
## Big Run
@time sol = solve(prob::SDEProblem,[0;500],Δt=(1/2)^(8),save_timeseries=true,alg=:SRIW1Optimized,
...
p1 = plot(sol.ts,sol.timeseries[..,16],top_margin=50px,title="(A) Timeseries of Ecad Concentration",xguide="Time (s)",yguide="Concentration",guidefont=font(16),tickfont=font(16),linewidth=lw,left_margin=85px,leg=false)
p2 = plot(sol.ts,sol.timeseries[..,17],top_margin=50px,title="(B) Timeseries of Vim Concentration",xguide="Time (s)",yguide="Concentration",guidefont=font(16),tickfont=font(16),linewidth=lw,leg=false)
p3 = plot(sol.ts,sol.Δts,xguide="Time (s)",yguide="Accepted Dt",title="(C) Accepted Dt vs Time", guidefont=font(16),tickfont=font(16),yscale=:log10,linewidth=lw,left_margin=110px,bottom_margin=65px,leg=false)
