...
res.u = res.u + 1.999 #Translate solution to right energy since Neumann
Plots.surface(femMesh.node[:,1],femMesh.node[:,2],res.u,zlim=(0,2),cbar=false)
#solplot_appx(res,savefile="plot.svg") #Approximately Flat solution at 2 is translated to integral = 0
